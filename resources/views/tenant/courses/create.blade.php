...
<form action="{{route('tenant.courses.store')}}" method="post">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('title') is-invalid @enderror " name="title"
                            id="title" aria-describedby="Tilte help" placeholder="">
                        @error('title')
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('price') is-invalid @enderror "
                                    name="price" id="price" aria-describedby="Tilte help" placeholder="">
                                @error('price')
                                    <div class="invalid-feedback">
                                        <span class="text-danger">{{ $message }}</span>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('sale_price') is-invalid @enderror "
                                    name="sale_price" id="sale_price" aria-describedby="Tilte help" placeholder="">
                                @error('sale_price')
                                    <div class="invalid-feedback">
                                        <span class="text-danger">{{ $message }}</span>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                              <label for="sale_price_effective_starts" class="form-label">{{__("Sale price effective date")}}</label>
                              <input  type="datetime-local"
                                class="form-control" name="sale_price_effective_starts" id="sale_price_effective_starts" aria-describedby="helpId" placeholder="">
                              <small id="helpId" class="form-text text-muted">{{__("Date and time salle price to be considered")}}</small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                              <label for="sale_price_effective_ends" class="form-label">{{__("Sale price effective date ends")}}</label>
                              <input type="datetime-local"
                                class="form-control" name="sale_price_effective_ends" id="sale_price_effective_ends" aria-describedby="helpId" placeholder="">
                              <small id="helpId" class="form-text text-muted">{{__("Date and time salle price to be considered")}}</small>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="full_description" id="full_description" rows="10"></textarea>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card mb-3">
                <div class="card-body">
                  ...
                  <input type="file"
                    class="form-control" name="cover_photo" id="cover_photo" aria-describedby="" placeholder="">
                </div>
            </div>
            <div class="card mb-3">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-7">
                            <div class="mb-3">
                              ...
                              <small id="helpId" class="form-text text-muted">{{__("Duration of this course")}}</small>
                            </div>
                        </div>
                        <div class="col-md-5">
                            <div class="mb-3">
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <small class="form-text text-muted">{{__("Only active courses will show to students")}}</small>
                        </div>
                    </div>
                    <div class="col">
                        <div class="mb-3">
                            <label for="category_id" class="form-label">{{ __('Category') }}</label>
                            <select class="form-select select2 " name="category_id[]" id="category_id" multiple="multiple">
